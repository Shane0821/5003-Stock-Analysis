...
# sudo docker tag kafka-websocket:latest shane233/kafka-websocket:latest
...
# sudo docker push shane233/kafka-websocket:latest
# sudo docker rmi shane233/topic-register:latest shane233/data-producer:latest shane233/streaming-processor:latest shane233/k8s-spark:latest shane233/reddit-producer:latest shane233/kafka-websocket:latest